...
std::vector<PllSplitList> Util::create_splits(int n, std::string file_name) {
    auto tree_single_str = get_output_of_bash_command("head -n " + std::to_string(n) + " /rf_data/BS/" + file_name);
